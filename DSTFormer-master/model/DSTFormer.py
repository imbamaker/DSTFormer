...
class DSTFormerBlock(nn.Module):
    """
    Implementation of DSTFormer block. It has two ST and TS branches followed by adaptive fusion.
    """
...
class DSTFormer(nn.Module):
    """
    DSTFormer, the main class of our model.
    """
